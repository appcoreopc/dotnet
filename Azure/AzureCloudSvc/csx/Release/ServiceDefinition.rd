...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="AzureCloudSvc" generation="1" functional="0" release="0" Id="4529dede-1037-4c41-9f6d-87c2543fa157" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="AzureCloudSvcGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="AzureWorkProcess" generation="1" functional="0" release="0" software="D:\test\demo\C#\AzureCloudSvc\csx\Release\roles\AzureWorkProcess" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <settings>
